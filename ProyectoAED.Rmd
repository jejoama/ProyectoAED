...
Los valores ausentes se encuentran concentrados en la variable `Total`.
...
Se observa que los datos faltantes son del tipo MAR, valores faltantes vienen asociados a grupos de edad altos y cuya relación con la actividad económica es "Parados que buscan primer empleo" o "Parados".
...
# Calcular desviación estándar y varianza por sexo
...
t.test(Tasa_actividad ~ Sexo, data = df_clean)#%>% filter(Periodo == 2024,Edad%in%edades_focales))
